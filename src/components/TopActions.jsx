...
/**
 * Top Actions Header:
 * - Left: Location Pin Button + Matching Audio Music BGM Button
 * - Right: Compact Language Toggle Pill (EN | தமிழ்)
 */
export default function TopActions({ lang, setLang, isPlaying, toggleAudio }) {
  return (
    <header className="top-actions-bar">
      {/* Top Left Action Buttons (Location Pin & Audio Toggle) */}
      <div className="top-left-actions">
        {/* 1. Trending Location Button */}
        <a
          href={MAPS_URL}
          target="_blank"
        ...
        {/* 2. Matching Audio BGM Toggle Button (Next to Location Pin) */}
        <button
          type="button"
